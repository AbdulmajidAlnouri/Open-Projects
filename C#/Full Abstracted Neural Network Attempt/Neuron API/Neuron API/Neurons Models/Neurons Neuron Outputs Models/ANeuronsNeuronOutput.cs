...
{
    public class ANeuronsNeuronOutput : ANeuronInputs, INeuronsNeuronOutput
    {

        public ANeuronsNeuronOutput(IEnumerable<INeuronOutput> passedNeuronOutputs):base(passedNeuronOutputs)
        {
        }
